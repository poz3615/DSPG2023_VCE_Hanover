...
leaflet() %>%
  addTiles() %>%
  addPolygons(data = colored_land, color = ~color_map(colored_land$land_use), stroke = 1, weight = 1) %>%
  addLegend(values = land_use, pal = color_map, position = "bottomright", title = "Land Parcel Types in Hanover County")
