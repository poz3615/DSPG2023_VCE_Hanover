...
land_use <- function(comb_zone) {
  if (is.na(comb_zone)) {
    ...
    return("Agriculture")
  } else if (comb_zone == "R-1" || comb_zone == "R-2" || comb_zone == "R-3" || comb_zone == "R-4" || comb_zone == "R-5" || comb_zone == "R-6" || comb_zone == "RS" || comb_zone == "RM" || comb_zone == "RR-1" || comb_zone == "POB") {
    return("Residential")
  } else if (comb_zone == "B-1" || comb_zone == "B-2" || comb_zone == "B-20" || comb_zone == "B-2O"|| comb_zone == "B-4" || comb_zone == "B-3" || comb_zone == "B-O" || comb_zone == "B-0" ||comb_zone == "RS" || comb_zone == "RM" || comb_zone == "OS" || comb_zone == "O-S" || comb_zone == "RO-1" || comb_zone == "HE" || comb_zone == "PSC" || comb_zone == "MX") {
    return("Commercial")
...
new_ag <- ag[, c("land_use", "ZONING_LIS", "Zone", "LEGALDESC", "LOT_ACRES", "OWN_NAME1", "OWN_NAME2", "MAILINGADDRESS", "ADDRESS")]
